        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="formProduct.php" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Scale ?:10" name="productScale" required="required">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Description" name="productDescription" required="required">
            </div>
            <div class="form-group">
              <label>Quality In Stock *</label>
              <input type="text" class="form-control" placeholder="Quality In Stock" name="quantityInStock" required="required">
            </div>
            <div class="form-group">
